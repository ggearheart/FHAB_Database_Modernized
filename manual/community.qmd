...
::: {.callout-warning title="Use a safe email"}
This is a test system holding only open or demo data. If you provide an email, use a **work or
publicly available** address — not a private/sensitive one — and **don't enter any PII** you
wouldn't want disclosed. See the [data &amp; privacy disclaimer](index.qmd).
:::
